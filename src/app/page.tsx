        ...
        <div className="flex flex-wrap justify-center gap-4">
         ...
         {/* Glass Email Button */}
          <a 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold hover:bg-white/20 hover:scale-105 transition-all duration-300 shadow-lg"
          >
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white font-bold hover:bg-white/15 hover:border-white/30 hover:scale-105 transition-all duration-300 shadow-lg"
          >
          ...
          {/* Glass LinkedIn Button */}
          <a 
            href="https://www.linkedin.com/in/pranav-prasad-5b6597323/" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-blue-500/20 backdrop-blur-md border border-blue-500/30 text-white font-bold hover:bg-blue-500/40 hover:scale-105 transition-all duration-300 shadow-[0_0_15px_rgba(37,99,235,0.2)]"
          >
