      ...
      <div className="flex flex-col items-center mb-20 text-center mt-10 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-black font-bold hover:bg-neutral-200 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)]"
          >
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-neutral-900 border border-neutral-700 text-white font-bold hover:bg-neutral-800 hover:border-neutral-500 hover:scale-105 transition-all duration-300"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer" 
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-blue-600 text-white font-bold hover:bg-blue-500 hover:scale-105 transition-all duration-300 shadow-[0_0_15px_rgba(37,99,235,0.4)]"
          >
